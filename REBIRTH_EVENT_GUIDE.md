# ☸️ GIẢI ĐẤU TÁI SINH – BÀN CỜ LUÂN HỒI
## 📝 Lệ Luật & Hướng Dẫn Tham Gia Sự Kiện Cát Tường

Chào mừng chư vị đồng tu đến với **Giải Đấu Tái Sinh - Bàn Cờ Luân Hồi**, một sự kiện đặc biệt kết hợp giữa thực hành tâm linh sâu sắc và trải nghiệm hành trình luân hồi trên bàn cờ 108 cảnh giới. Đây là cơ hội để chư vị chuyển hóa năng lượng thiền tập tinh tấn hàng ngày thành những bước tiến vượt bậc trên hành trình tiến tới các cõi tịnh độ an lạc.
...
## 🎲 2. Luật Chơi & Cơ Chế Hoạt Động

### 🚶‍♂️ Gieo Xúc Xắc Tái Sinh
* Người chơi sử dụng **Xúc xắc Tái sinh** để nhận số bước di chuyển ngẫu nhiên từ `1 đến 6 ô` trên Bàn cờ Luân hồi gồm **108 ô cảnh giới** khác nhau.
...
> Trong trường hợp có từ hai đồng tu trở lên đạt **Tổng điểm bằng nhau**, hệ thống sẽ tự động áp dụng cơ chế phân định như sau:
> * **Ưu tiên đạt trước:** Người chơi nào đạt được mốc tổng điểm đó sớm nhất (tính theo thời gian ghi nhận điểm hoạt động sớm nhất trong hệ thống cơ sở dữ liệu `created_at ASC`) sẽ xếp ở thứ hạng cao hơn.
> * Việc tinh tấn sớm luôn mang lại phước báu và lợi thế lớn trong việc tranh chấp thứ hạng!
...
| :---: | :--- | :--- | :--- |
| **Hạng 1** | 🥇 Cúp Luân Hồi Vàng | `Vô Thượng Giác Ngộ` *(Khung tên Hoàng Kim lấp lánh)* | 🧘‍♂️ 1 Khóa tu Vipassana chuyên sâu trọn gói |
| **Hạng 2** | 🥈 Cúp Luân Hồi Bạc | `Hộ Pháp Trí Tuệ` *(Khung tên Bạc tinh xảo)* | 🖼️ 1 Bức tranh Thangka Nepal vẽ tay thủ công cao cấp |
| **Hạng 3** | 🥉 Cúp Luân Hồi Đồng | `Tinh Tấn Hành Giả` *(Khung tên Đồng cổ kính)* | 📿 1 Chuỗi hạt Bồ Đề Tây Tạng cổ cát tường |
| **Hạng 4 - 5** | 🎗️ Kỷ niệm chương | `An Lạc Cư Sĩ` | 📚 Bộ sách Thiền học ứng dụng chọn lọc |
| **Hạng 6 - 10** | 🎗️ Kỷ niệm chương | `Tinh Tấn Đồng Tu` | 🪵 Hộp trầm hương tự nhiên thượng hạng |

*(Lưu ý: Danh hiệu độc quyền sẽ được hiển thị nổi bật và lấp lánh ngay bên cạnh tên của đạo hữu trên toàn hệ thống bảng xếp hạng, sảnh tương tác và trang cá nhân).*

---

## 🛡️ 6. Quy Định Kỷ Luật & Tính Trung Thực

* **Thiền thực chất - Nghiệp quả thực:** Ban tổ chức cam kết xây dựng một môi trường tu tập thanh tịnh và trung thực. Mọi hành vi gian lận bao gồm: sửa đổi thời gian thiết bị, sử dụng auto-clicker, bots, hoặc phần mềm giả lập để tự động tạo điểm giả sẽ bị phát hiện bởi hệ thống giám sát tự động.
* **Hình thức xử lý:** Tài khoản vi phạm sẽ bị **tước quyền tham gia sự kiện**, loại bỏ vĩnh viễn khỏi Bảng xếp hạng và thu hồi toàn bộ số điểm tích lũy không hợp lệ.

---

*Chúc chư vị đồng tu luôn giữ được tâm quân bình, tinh tấn thực hành thiền tập hàng ngày để chuyển hóa nghiệp lực, tích lũy công đức và đạt được những vị trí cao nhất trên Bàn Cờ Luân Hồi cát tường!*
