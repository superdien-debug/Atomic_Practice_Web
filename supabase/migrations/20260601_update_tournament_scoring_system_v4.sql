-- Migration: Upgrade Tournament Scoring System v4 - Separate Realm & Attendance, allow negative Realm Score
-- Date: 2026-06-01
...
BEGIN
    ...
    SELECT 
        ...
        )::BIGINT AS realm_score, -- Cho phép âm để tăng kịch tính đua top
        (
